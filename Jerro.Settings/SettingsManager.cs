...
using Jerro.Settings.Encryption;
using Jerro.Settings.Serialization;
    ...
    public abstract partial class SettingsManager
    {
        ...
        public virtual void Save()
        {
            try
            {
                ...
                if (DataProtector != null)
                    serialized = DataProtector.Protect(serialized);
        ...
        public virtual void Load()
        {
            try
            {
                ...
                if (DataProtector != null)
                    serialized = DataProtector.Unprotect(serialized);
